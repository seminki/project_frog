   ...
   ">
        <div>
            ...
            <div class="filter_con" style="display:inline-flex;">
                ...
                <div class="" style="width: 100%; display: flex; flex-wrap: wrap; max-width: 85%;">
                    <!-- 오른쪽 제품 -->
                    <div class="products" style="width: 100%; background-color: rgb(245, 245, 245);">
                        <!-- 제품목록 -->
