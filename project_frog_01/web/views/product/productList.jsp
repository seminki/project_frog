					...
					<div class="filter_box" style="width: 200px;">
						...
						<div>
							<input type="text" name="" id=""
								style="border: 2px black solid; border-radius: 10px; width: 80%;"><br>
							<style>
ul li {
	list-style: none;
}
							...
							<span>best sellers (#)</span> <br> <label for=""><input
								type="checkbox" value="new releases"></label> <span>new
								releases (#)</span>
						</div>
					</div>
					<div class=""
